...
export default class ConsultasCreate extends Component {
    ...
    constructor(props) {
        ...
        this.state = { 
            ...
            doencas: [], 
            remedios: [], 
            medico: { crm: 'Não selecionado' }, 
            detalhes: '' };
    }

    onAddDoencas = (doencasAux) => {
        this.setState({ doencas: doencasAux });
    }
                ...
                <Content>
                    <Form style={styles.form}>
                        ...
                        <Item inlineLabel style={styles.item}>
                            ...
                            <Button 
                                transparent 
                                onPress={() => this.props.navigation.navigate('DoencasSearch', 
                        ...
                        <Item inlineLabel style={styles.item}>
                            ...
                            <Button 
                                transparent 
                                onPress={() => this.props.navigation.navigate('MedicosSearch', 
                        ...
                        <Item inlineLabel style={styles.item}>
                            ...
                            <Button 
                                transparent 
                                onPress={() => this.props.navigation.navigate('RemediosSearch', 
